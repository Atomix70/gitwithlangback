...
adminRouter.post('/addbook/add',function(req,res)
{
    ...
    //     {
            ...
            // var book={
            //     Image:"images/"+req.body.book.bookImage,
            //     Title:req.body.book.bookTitle,
            //     Author:req.body.book.bookAuthor,
            //     Country:req.body.book.bookCountry,
            //     Language:req.body.book.bookLanguage,
            //     Pages:req.body.book.bookPages,
            //     Year:req.body.book.bookYear,
            //     Link:req.body.book.bookLink
            //     }
            //     res.send(book)
            //     console.log(book)
